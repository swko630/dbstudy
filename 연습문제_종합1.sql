...
*/
 ...
 BOOK_NAME VARCHAR(100 BYTE),
 PUBLISHER VARCHAR(50 BYTE),
 PRICE NUMBER(6)
 );
...
*/
 CREATE TABLE CUSTOMER_T(
   ...
   CUST_NAME VARCHAR(20 BYTE),
   CUST_ADDT VARCHAR(50 BYTE),
   CUST_TEL VARCHAR(20 BYTE)
   );
...
*/
  ...
  ORDER_ID VARCHAR(20 BYTE) NOT NULL,
  CUST_ID NUMBER(11) ,
  BOOK_ID NUMBER(11),
  AMOUNT NUMBER(2),
  ORDERED_AT DATE  
...
*/
 ...
 INSERT INTO BOOK_T(BOOK_ID, BOOK_NAME, PUBLISHER, PRICE) VALUES(BOOK_SEQ.NEXTVAL,'축구를 아는 여자','나이스북', 13000);
 ...
 INSERT INTO BOOK_T(BOOK_ID, BOOK_NAME, PUBLISHER, PRICE) VALUES(BOOK_SEQ.NEXTVAL,'올림픽 이야기','심성당', 7500);
...
*/
 ...
 INSERT INTO CUSTOMER_T(CUST_ID, CUST_NAME, CUST_ADDR, CUST_TEL) VALUES(BOOK_SEQ.NEXTVAL, '박지성', '영국', '000-000-000'); 
 INSERT INTO CUSTOMER_T(CUST_ID, CUST_NAME, CUST_ADDR, CUST_TEL) VALUES(BOOK_SEQ.NEXTVAL, '김연아', '대한민국','111-111-111'); 
 INSERT INTO CUSTOMER_T(CUST_ID, CUST_NAME, CUST_ADDR, CUST_TEL) VALUES(BOOK_SEQ.NEXTVAL, '장미란', '대한민국', '222-222-222');  
 INSERT INTO CUSTOMER_T(CUST_ID, CUST_NAME, CUST_ADDR, CUST_TEL) VALUES(BOOK_SEQ.NEXTVAL, '추신수', '미국', '333-333-333');
 INSERT INTO CUSTOMER_T(CUST_ID, CUST_NAME, CUST_ADDR, CUST_TEL) VALUES(BOOK_SEQ.NEXTVAL, '박세리', '대한민국', NULL );
...
*/
 ...
 INSERT INTO ORDER_T(ORDER_ID, CUST_ID, BOOK_ID, AMOUNT, ORDERED_AT) VALUES(ORDER_SEQ.NEXTVAL, 1000, 1, 1, 20/07/01);
 INSERT INTO ORDER_T(ORDER_ID, CUST_ID, BOOK_ID, AMOUNT, ORDERED_AT) VALUES(ORDER_SEQ.NEXTVAL, 1000, 3, 2, 20/07/03);
 INSERT INTO ORDER_T(ORDER_ID, CUST_ID, BOOK_ID, AMOUNT, ORDERED_AT) VALUES(ORDER_SEQ.NEXTVAL, 1001, 5, 1, 20/07/03);
 INSERT INTO ORDER_T(ORDER_ID, CUST_ID, BOOK_ID, AMOUNT, ORDERED_AT) VALUES(ORDER_SEQ.NEXTVAL, 1002, 6, 2, 20/07/04);
 INSERT INTO ORDER_T(ORDER_ID, CUST_ID, BOOK_ID, AMOUNT, ORDERED_AT) VALUES(ORDER_SEQ.NEXTVAL, 1003, 7, 3, 20/07/05);
 INSERT INTO ORDER_T(ORDER_ID, CUST_ID, BOOK_ID, AMOUNT, ORDERED_AT) VALUES(ORDER_SEQ.NEXTVAL, 1000, 2, 5, 20/07/07);
 INSERT INTO ORDER_T(ORDER_ID, CUST_ID, BOOK_ID, AMOUNT, ORDERED_AT) VALUES(ORDER_SEQ.NEXTVAL, 1003, 8, 2, 20/07/07);
 INSERT INTO ORDER_T(ORDER_ID, CUST_ID, BOOK_ID, AMOUNT, ORDERED_AT) VALUES(ORDER_SEQ.NEXTVAL, 1002, 10, 2, 20/07/08);
 INSERT INTO ORDER_T(ORDER_ID, CUST_ID, BOOK_ID, AMOUNT, ORDERED_AT) VALUES(ORDER_SEQ.NEXTVAL, 1001, 10, 1, 20/07/09);
 INSERT INTO ORDER_T(ORDER_ID, CUST_ID, BOOK_ID, AMOUNT, ORDERED_AT) VALUES(ORDER_SEQ.NEXTVAL, 1000, 6, 4, 20/07/10);
  UPDATE ORDER_T
