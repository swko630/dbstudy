...
/*
원하는 자리로 올림(내림은 CEIL 자리에 FLOOR 만 대입)

CEIL(값 * POWER(10, 자리수)) / POEWR (10, 자리수)

CEIL(123.45 * 10) / 10 => 123.5
CEIL(123.456 * 100) / 100 => 123.46
CEIL(123.456 * POWER(10, 1)) / POWER(10, 1)
CEIL(123.456 * POWER(10, 2)) / POWER(10, 2)
CEIL(123.456 * POWER(10, -1)) / POWER(10, -1)
...
-- 7. 원하는 자리수로 반올림
SELECT ROUND(123.456)     -- 120 (정수 반올림)
...
-- 8. 원하는 자리수로 절사 (실무에서 많이 쓰임 EX 돈계산)
